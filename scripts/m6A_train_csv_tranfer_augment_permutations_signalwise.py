    ...
    for i in enumerate(sequences_np):
        if (i[1] == prev).all() == True:
            ...
            for j in range(0,100,20):
                temp_signals_event = temp_augmented[:,j:j+20]
                # permutate 
                for k in temp_signals_event:
                    shuffle(k)
                    pass
...
if __name__ == '__main__':
    ...
    checkpoint_filepath =  '/media/labuser/Data/nanopore/m6A_classifier/results/singleA/singleA30TL_aug_permutation_signalWise_150epochs/'
