...
parser = argparse.ArgumentParser(prog='CHEUI_preprocess_m6A v0.1', description=
                                 """ 
                                 This script takes a nanopolish file, parse it and extract 
                                 signals from 9-mers centered in Adenines and read IDs. Then it creates a file that will be the input of predict_model_1.py 
