...
------------------------------------------
   ...
   * [Outline of CHEUI-solo and CHEUI-diff](#outline-of-cheui-solo-and-cheui-diff)
   * [Preprocessing data before running CHEUI](#preprocessing-data-before-running-cheui)
   * [Install CHEUI](#install-cheui)
   * [IMPORTANT](#important)
   * [Detect m6A and m5C modifications in one condition](#detect-m6a-and-m5c-modifications-in-one-condition)
     * [CHEUI preprocessing step](#cheui-preprocessing-step)
       * [CHEUI preprocessing step -- C++ version](#cheui-preprocessing-step----c-version)
     * [CHEUI model 1: prediction of modifications in individual reads](#cheui-model-1-prediction-of-modifications-in-individual-reads)
       * [Sort the predictions to group all the predictions from the same site](#sort-the-predictions-to-group-all-the-predictions-from-the-same-site)
         * [Using only 1 replicate](#using-only-1-replicate)
   ...
   * [Identify differential RNA modifications between two conditions](#identify-differential--rna-modifications-between-two-conditions)
     ...
     * [Run CHEUI-diff](#run-cheui-diff)
     * [Example data files for CHEUI-diff](#example-data-files-for-cheui-diff)
